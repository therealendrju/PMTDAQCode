...
long warp_gzip_data(int nb, char* p, int no, char* out) {
...
long warp_gzip_data_s(int nb, short* p, int no, short* out) {
...
long warp_gunzip_data(int nb, char* p, int no, char* out) {
