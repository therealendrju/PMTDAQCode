...
AuxFrame::AuxFrame(const TGWindow *p, UInt_t w, UInt_t h,UInt_t options ) : TGMainFrame(p,w,h,options)
{
...
//   TGVerticalFrame * vframeright=new TGVerticalFrame(hframemain,200,200);
// 
...
void AuxFrame::draw_histo_in_pads(TObject * histo,int pad,TString option)
{
...
// void AuxFrame::draw_second_histo_in_pad(TObject * histo,int pad)
// {
// 
// 
// 	fEcanvasup->GetCanvas()->cd();
