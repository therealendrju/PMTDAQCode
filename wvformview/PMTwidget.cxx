...
//    fbatchButton = new TGCheckButton(hframemain,"batch refit");
//    fbatchButton->SetToolTipText("mark for refitting in the batch process.");
...
//    fbatchButton->MoveResize(48,336,128,32);
   ...
   fCloseupTextButton = new TGTextButton(hframemain,"Zoom");
   fCloseupTextButton->SetTextJustify(36);
   fCloseupTextButton->SetMargins(0,0,0,0);
   fCloseupTextButton->SetWrapLength(-1);
   fCloseupTextButton->Resize(192,48);
   fCloseupTextButton->SetToolTipText("Refit PMT setting parameters by hand");
   hframemain->AddFrame(fCloseupTextButton, new TGLayoutHints(kLHintsRight | kLHintsTop,2,2,2,2));
   fCloseupTextButton->MoveResize(288,328,192,48);
...
void PMTwidget::set_channel_label(TString text)
{

fPMTLabel->SetText(text);
...
TGTextButton * PMTwidget::get_closeup_button()
{
return fCloseupTextButton;;
}
